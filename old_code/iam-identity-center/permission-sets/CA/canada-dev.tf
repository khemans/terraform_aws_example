resource "aws_ssoadmin_permission_set" "ca-standard" {
  name             = "CA-Developer"
  description      = "Company Canada Developer Read Only"
  instance_arn     = var.instance_arn
  session_duration = "PT8H"
}

data "aws_iam_policy_document" "ca-standard" {
   statement {
    effect = "Allow"
    actions =  [
      ...
      "codedeploy:Get*",
      "codedeploy:List*",
      "codepipeline:GetActionExecution",
...
resource "aws_ssoadmin_permission_set_inline_policy" "ca-standard" {
  inline_policy      = data.aws_iam_policy_document.ca-standard.json
  instance_arn       = var.instance_arn
  permission_set_arn = aws_ssoadmin_permission_set.ca-standard.arn
}